...
<div class="cust-wrapper">
  <div class="row">
    <div class="col-md-12 text-center">
      <h1 class="mT40 mB40"><?php if($type == '1'){ echo  "Add Transportation Level";}else{ echo "Add Transportation Level"; } ?>
    </div>
  </div>
  <?php if( $error = $this->session->flashdata('add_bank')){ ?>
    ...
    <?php } ?>
  <?php echo form_open_multipart("admin/transportation_level/".$type);?>
    ...
    <div class="col-md-6">
        ...
        <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                         <label>Select Transportor</label>
                        <select name="comp_type" class="form-control">
                            <option>Select Transportor Level</option>
                            <option value="27" >Transportor Level 1</option>
                            <option value="28" >Transportor Level 2</option>                                    
                        </select>
                    </div>
                </div>
                <div class="row">
                ...
                if($type == 1){
                    ...
                    echo "<input type='hidden' name='type' value='32'>";
                }else if($type == 2){
               ...
               <!--  </div>
                 ...
                 <div class="row">
                    <div class="col-md-6">
                                <?php echo form_error('vehical_type'); ?>
                                <?php $vendor = $this->api_model->get_data('is_activated = "1"', "vehicals_type", '', '*'); ?>
                                <label>Select Vehicals Type</label>
                                <select name="vehical_type" class="form-control">
                                    <option value="">Select Vehicals Type</option>
                                    <?php foreach($vendor as $vd){ ?>
                                        <option value="<?= $vd['id'] ?>"><?= $vd['vehicals_name'] ?></option>
                                    <?php } ?>
                                </select>
                    </div>
               <!--  </div>
                  <div class="row"> -->
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name ='vehical_number' class="form-control" placeholder="Enter ...">
                        </div>
                    </div>
                </div>
                 <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <?php echo form_error('dl_number'); ?>
                            <label>DL Number</label>
                            <input type="text" name ='dl_number' class="form-control" placeholder="Enter ...">
                        </div>
                    </div>
               <!--  </div>
                  <div class="row"> -->
                    <div class="col-md-6">
                        <div class="form-group">
                            <?php echo form_error('per_km'); ?>
                            <label>Per KM</label>
                            <input type="text" name ='per_km' class="form-control" placeholder="Enter ..." >
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <?php echo form_error('labour_charge'); ?>
                            <label>Labour Charge</label>
                            <input type="text" name ='labour_charge' class="form-control" placeholder="Enter ...">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="exampleInputFile">Upload DL Image</label>
                          <input type="file" id="dl_image">
                          <input type="hidden" name="dl_image" id="dl_img" value="">
                          <!-- <button type="button" class="btn btn-success pull-right mR20 cust-pos"><i class="fa fa-plus"></i> Add new</button> -->
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label>District</label>
                                    <select name="district1[]" class="form-control city1"  id="district" multiple>
                                        <option>Select District</option>
                                    </select>
                                </div>
                            </div>
...
$(document).ready(function() {
                $('#dl_image').change(function(){
                    $('#file_name').html('');
                    $('#file_name').html($('#dl_image')[0].files[0].name);
                    var file_data = $('#dl_image').prop('files')[0];   
                    var form_data = new FormData();                  
                    form_data.append('image', file_data);
                    $('.ref3').show();
                    $.ajax({
