...
<section class="content">
	          	<div class="box-header with-border">
		              ...
		              <a class="white" href="<?= base_url('admin/add_subuser/1'); ?>"><div class="btn btn-info but_set">
					  		Add Bank
		              </div></a>
 ...
 $(document).ready(function() {
    ...
    function pageselectCallback(page_index, jq, event_type){
     ...
     if($_SESSION['status'] == 1){ ?>
        var get_url = "<?php echo base_url('api/listing_authority').'?user_type=5'?>";
     <?php }else{ ?>
      var get_url = "<?php echo base_url('api/listing_authority').'?user_type=5&admin_id='.$_SESSION['user_id'].''; ?>";
     <?php }
      ?>
