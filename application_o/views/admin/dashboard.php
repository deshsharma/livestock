...
<section class="content-header">
      <h1>
        ...
        <small>
          <?php if($_SESSION['status'] == '18'){ echo "Ecommerce Management";}else if($_SESSION['status'] == '12' || $_SESSION['status'] == '20' || $_SESSION['status'] == '14' || $_SESSION['type'] == '11' || $_SESSION['type'] == '10' || $_SESSION['status'] == '19' || $_SESSION['status'] == '13' || $_SESSION['status'] == '15' || $_SESSION['status'] == '16'){ echo "Ecommerce Management";}else{ echo "LIVESTOC";}?>
        </small>
      </h1>
      <ol class="breadcrumb">
...
<section class="content">
      <div class="row">
        <?php if($_SESSION['status'] == '18' || $_SESSION['status'] == '29'){ ?>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-green">
              <div class="inner">
                ...
                if($_SESSION['status'] != '1')
                $user_id = $this->session->userdata("user_id"); 
                $data =  $this->api_model->product_interest_search('', $user_id, '', '');  echo $data['count'];?></h3>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Veterinarians</span>
                  <span class="info-box-number"><?= isset($farmer)?$farmer:0; ?></span>
                </div>
                <!-- /.info-box-content -->
              </div>
              <!-- /.info-box -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Paravets</span>
                  <span class="info-box-number"><?= isset($counstomer)?$counstomer:0;  ?></span>
                </div>
                <!-- /.info-box-content -->
              </div>
              <!-- /.info-box -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number"><?= isset($order_count)?$order_count:0;  ?></span>
                </div>
                <!-- /.info-box-content -->
              </div>
              <!-- /.info-box -->
