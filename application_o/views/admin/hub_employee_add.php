...
<div class="abc_1" >
    ...
    <?php } ?>
        <?php echo form_open("admin/hub_employee_add/", ['onsubmit'=>'return myFunction()']);?>
            ...
            <div class="col-md-3" > 
                ...
                <div class="col-md-9">
                    <select name="hub" class='ch_manset padd_set'>
                        ...
                        foreach($hub as $h){
                            ?>
                            <option value="<?= $h['admin_id'] ?>"><?= $h['fname'] ?></option>
                            <?php
                        } 
                        ?>
                    </select>
            ...
            <div class="col-md-3" > 
                ...
                <div class="col-md-9">
                    <?php echo form_input(['type'=>'text','name'=>'mobile', 'value'=>'', 'id'=>'name','class'=>'ch_manset padd_set']) ?>
        	</div>
            ...
            <div class="col-md-3" > 
                ...
                <div class="col-md-9">
                    <?php echo form_input(['type'=>'text','name'=>'email', 'value'=>'', 'id'=>'name','class'=>'ch_manset padd_set']) ?>
            </div>
            ...
            <div class="col-md-3" > 
                ...
                <div class="col-md-9">
                    <?php echo form_input(['type'=>'text','name'=>'address', 'value'=>'', 'id'=>'name','class'=>'ch_manset padd_set']) ?>
        	</div>
