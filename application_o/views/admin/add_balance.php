...
<div class="abc" ><h3>ADD LIVESTOC BALANCE</h3></div>

<div class="abc_1" >
      <?php if( $error = $this->session->flashdata('add_balance_amount')){ ?>
    ...
    <?php } ?>
        <?php echo form_open("admin/add_balance/");?>
            <?php echo form_error('balance_amount'); ?>
            <div class="col-md-3" > 
        	   <strong class="right_sre">livestoc balance</strong>
            </div>
            <div class="col-md-9">
                <?php echo form_input(['type'=>'text','name'=>'balance_amount', 'value'=>'', 'id'=>'balance_amount','class'=>'ch_manset padd_set']) ?>
        	</div>
