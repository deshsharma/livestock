          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header with-border">
                  <h3 class="box-title">VT LIST</h3>
                    <div class="">
							<span><bold>Total User : <span id="tot_count" style="color: #f30808;">0</span></bold></span>
				    </div>
    ...
    function pageselectCallback(page_index, jq, event_type){
     ...
     function initPagination() {
      ...
      function loadData(start,per_page,event_type){
                ajaxloader.load("<?php echo base_url('admin/doctor_search').'?name=' ?>"+$('#product_name').val()+"&start="+start+"&perpage="+per_page+"&doc_code="+<?= $data[0]['refral_code'] ?>, function(resp){
                              var data = resp;
                              var str =JSON.parse(data);
                              var tr = '';
                            if(str.count[0].count=='0'){ 
