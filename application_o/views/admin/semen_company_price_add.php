...
<div class="abc" ><h3>ADD COMPANY GROUP PRICE</h3></div>
<div class="abc_1" >
    ...
    <?php } ?>
    <?php echo form_open("admin/semen_company_price_add/", ['onsubmit'=>'return myFunction()']);?>
            ...
            <div class="col-md-3" > 
                ...
                <select class="form-control" name="company" style="margin-bottom: 10px;" >
                    ...
                    <?php foreach($data2 as $da){ ?>
                        <option value="<?= $da['admin_id']?>"><?= $da['fname'] ?></option>
                    <?php } ?>
                </select>
