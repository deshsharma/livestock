...
<div class="content-wrapper">
    <section class="content">
        <div class="box-header with-border">
            <h3 class="box-title">Semen Stock by Transfer</h3>
        </div>
                ...
                //                $('#count').val(result.count[0].count);
                                // delete result.count ;
                                  $.each(result, function(index, item){
                                    ...
                                    var status = '';
                      // if(item.id != 1){
                        status = '<div class="col-md-12"><input type="number" class="form-control" placeholder="No of Straw" min="0" name="strow_'+item.id+'"></div>';
  ...
  <?php }  
    ...
    ajaxloader.load(url, function(resp){
                              ...
                              if(str.success == false){
                                  ...
                                  var status = '';                   
                                    status += "<a href='<?= base_url()?>admin/semen_stock_transfer/"+item.doctor_id+"/"+$('#type').val()+"'><button type='button' class='btn btn-info partner'>Select</button></a>";
                                     tr+="<div class='col-12 col-sm-6 col-md-4 d-flex align-items-stretch'><div class='card bg-light'>\
                                                    <div class='card-header text-muted border-bottom-0'>\
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\
                                                    </div>\
