	        ...
	        <div class="col-xs-12">
	          <div class="box">
	          	<div class="box-header with-border">
					  ...
					  <div class="col-md-12">
		              <div class="col-md-6"><span >Tatal</span>:<span class="total"></span>Rs</div>
					  ...
					  <input type="" name="transaction_id" id="transaction_id" value="">
					  <button id="pay" class="btn btn-primary">Recived</button>
	            </div>
		         <div class="box-body">
    ...
    function pageselectCallback(page_index, jq, event_type){
     ...
     function initPagination() {
      ...
      function loadData(start,per_page,event_type){
      					ajaxloader.load("<?php echo base_url('admin/delivery_partner_order_search').'?name=' ?>"+$('#product_name').val()+"&start="+start+"&perpage="+per_page+"&delivery_id=<?= $id ?>&cod=1", function(resp){
			                      	var data = resp;
			                      	var str =JSON.parse(data);
			                      	var tr = '';
			                     	if(str.count[0].count=='0'){ 
