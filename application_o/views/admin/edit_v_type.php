...
<div class="abc" ><h3>EDIT VEHICLE TYPE</h3></div>
...
<div class="abc_1" >
    ...
    <?php } ?>
        <?php echo form_open("admin/edit_v_type/".$data[0]['id'], ['onsubmit'=>'return myFunction()']);?>
            <?php echo form_error('name'); ?>
            <div class="col-md-3" > 
                <strong class="right_sre">Type Name</strong>
                </div>
                <div class="col-md-9">
                    <?php echo form_input(['type'=>'text','name'=>'name', 'value'=>$data[0]['vehicals_name'], 'id'=>'name','class'=>'ch_manset padd_set']) ?>
        	</div>
            ...
            <div class=" col-md-9">
                        ...
                        <input type="hidden" name="pro_image" id="pro_image1" value="<?= $data[0]['image'] ?>">
                        <div id="uploaded_image"><?php if($data[0]['image']){ echo "<img src='https://www.amazebrandlance.com/uploads/mastitis/".$data[0]['image']."'>";} ?></div>
            </div>
