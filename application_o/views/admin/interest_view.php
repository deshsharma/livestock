...
<div class="content-wrapper">
    ...
    $query = 'SELECT DISTINCT(p.id) as int_id,pi.*, u.*, p.* FROM produc_interest as pi, product as p, users as u where pi.product_id = p.id AND  u.users_id = pi.users_id  AND pi.id = "'.$id.'"';
    ...
    <?php 
    if($data[0]['is_paid'] == '0'){
        redirect(base_url('admin/buy_lead/'.$id));
    }
    ?>
    <!-- Main content -->
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-12 col-sm-6">
              ...
              <hr>
              <h2 class="lead"><b><?= $data[0]['name'] ?></b></h2>
                <p class="text-muted text-sm prod"><b>SKU : </b><?= $data[0]['sku'] ?></p>
                <p class="text-muted text-sm prod"><b>Height : </b><?= $data[0]['hight'] ?></p>
                <p class="text-muted text-sm prod"><b>Width : </b><?= $data[0]['width'] ?></p>
                <p class="text-muted text-sm prod"><b>Color : </b><?= $data[0]['color'] ?></p>
                <p class="text-muted text-sm prod"><b>Generic Name : </b><?= $data[0]['name'] ?></p>
                <p class="text-muted text-sm prod"><b>Brand Name : </b><?= $data[0]['brand'] ?></p>
                <p class="text-muted text-sm prod"><b>Coustomer Name : </b><?= $data[0]['full_name'] ?></p>
                <p class="text-muted text-sm prod"><b>Coustomer Mobile : </b><?= $data[0]['mobile'] ?></p>
