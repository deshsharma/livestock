              ...
              <div class="row">
               ...
               <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Semen Bank</label>
                    <input type="text" name="bull_bank_name" class="form-control" placeholder="Enter ..." value="<?= $bull_data[0]['bull_bank_name'] ?>" >
                  </div>
                </div>
                <div class="col-md-6">              
                  <div class="form-group">
                    ...
                    <?php
                    $semen_group = $this->api_model->get_data('', 'semen_group','','*');
                    ?>
                    <select name='groups' class="form-control">
                      <option value="">Select Type</option>
                    <?php
                    foreach($semen_group as $sem){ ?>
                      <option value="<?= $sem['id'] ?>" <?php if($bull_data[0]['groups'] == $sem['id']){ echo 'selected="selected"'; } ?> ><?= $sem['group'] ?></option>
                    <?php } ?>
                    </select>
                    <!-- <input type="text" name="groups" class="form-control" placeholder="Enter ..." value="<?= $_POST['groups'] ?>" > -->
                  </div>
                </div> 
              </div>
              <div class="form-group">
...
$(document).ready(function() {
				$('#bull_image').change(function(){
					...
					$.ajax({
						url: "<?= base_url() ?>Api/web_cropper_images?path=bank",
						type: "POST",
						data: form_data,
						contentType: false,
						cache: false,
