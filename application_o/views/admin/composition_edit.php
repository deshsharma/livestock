...
<div class="abc" ><h3>EDIT COMPOSITION</h3></div>
...
<div class="abc_1" >
    ...
    <?php } ?>
        <?php echo form_open("admin_composition/edit/".$data[0]['id']);?>
            ...
            <div class="col-md-3" > 
                ...
                <div class="col-md-9">
                    <?php $unit = $this->api_model->get_data('isactive = "1"', 'unit'); 
                    ?>
                    <select name="rate_unit" class="ch_manset padd_set">
                        <option value="">Select Unit</option>
                        <?php foreach($unit as $da){ ?>
                            <option value="<?= $da['id'] ?>" <?php if($data[0]['unit'] == $da['id']){ echo "selected"; } ?>><?= $da['name'] ?></option>
                        <?php } ?>
                    </select>
        	</div>
