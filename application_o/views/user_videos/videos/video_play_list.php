                                    ...
                                    <div class="courses-title">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6">
                                                <a title="Play Video" id="thumbnail" class="yt-simple-endpoint inline-block style-scope ytd-thumbnail" aria-hidden="true" tabindex="-1" rel="null" href="<?= base_url()."all_videos/video_play_list?video_id=".$video['video_id']. "&group_number=".$video['users_video_group_number']; ?>">
                                                    <yt-img-shadow ftl-eligible="" class="style-scope ytd-thumbnail no-transition" style="background-color: transparent;" loaded=""><!--css-build:shady--><img id="img" class="style-scope yt-img-shadow" alt="" src="<?= $video['video_thumb']; ?>" width="9999"></yt-img-shadow>
                                                </a>
                                               <!-- <?php 
                                                //if($this->session->userdata("user_type") == 0 || $vi[0]['user_id'] == $this->session->userdata("users_id")) { ?>  
                                                    <video controls>
                                                      <source src="<?= base_url() .'uploads/videos/'.$video['video']; ?>" type="video/mp4">
                                                      Your browser does not support HTML video.
                                                    </video>
                                                <?php// } else if($video['isactive'] !== '1') { ?>  -->
                                                    ...
                                                    <img src="<?= base_url('uploads/videos/images/').$video['video_thumb'] ?>" style="width:100%;height:100%;"></a> 
                                                    <!-- <p>For full video make payment</p>   -->
                                                <?php// } else { ?>
                                                    <!-- <video controls>
                                                        <source src="<?= base_url() .'uploads/videos/'.$video['video']; ?>" type="video/mp4">
                                                        Your browser does not support HTML video.
                                               ...
                                               <?php //} ?>
                                        <!-- <span class="video-number1"><?php //echo $key + 2 ?></span> -->
                                        <div class="videoitems">
                                        ...
                                        <div class="icons">
                                            ...
                                            <div class="row">
                                                ...
                                                <!-- <div class="col-xs-12 mt10">
                                                    <p class="qualification mb0"><i class="fa fa-graduation-cap"></i> Qualification: <?= $vi[0]['qualifications'];?></p>
                                                </div> -->
                                            </div>
                                        </div>
                                            <!-- <div class="col-lg-6 col-md-6">
                                               <a id="thumbnail" class="yt-simple-endpoint inline-block style-scope ytd-thumbnail" aria-hidden="true" tabindex="-1" rel="null" href="<?= base_url()."all_videos/video_play_list?video_id=".$video['video_id']. "&vid_id=".$video['id']; ?>">
                                                    <h5 class="headingcol"><?= $video['title'] ?></h5>
                                                </a> -->
                                                <!-- <span class="grey">By  <?= $vi[0]['user_name'] ?></span> -->


                                        <!-- <div class="video-ins grey">
                                            <div class="row">
                                                <div class="col-xs-12 mt10">
                                                    <p class="institute mb0"><i class="fa fa-university"></i> Institute: <?= $vi[0]['institute'];?></p>
                                                </div>
                                                <div class="col-xs-12 mt10">
                                                    <p class="qualification mb0"><i class="fa fa-graduation-cap"></i> Qualification: <?= $vi[0]['qualifications'];?></p>
                                                </div>
