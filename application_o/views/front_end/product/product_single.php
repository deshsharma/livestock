      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 product-details pl-md-5 ftco-animate">
            ...
            <p class="fordetails"><span><?= $language_library['Product Code'] ?> :</span> <?= $data[0]['sku'] ?> <!-- (<svg class="w3" x="0px" y="0px" viewBox="0 0 500 500">
                        <use xlink:href="#rupee"></use>
                        </svg> 300 per Test)</p> -->
                    <p class="fordetails"><span><?= $language_library['Company'] ?>:</span> <?= $data[0]['name'] ?> <!-- (<svg class="w3" x="0px" y="0px" viewBox="0 0 500 500">
                        <use xlink:href="#rupee"></use>
                        </svg> 300 per Test)</p> -->
              ...
              <div class="col-md-6">
                <div class="form-group d-flex">
                  <div class="select-wrap">
                    ...
                    <div class="row"> 
                     <div class="col-12">
                    <span> <?= $language_library['Select size of pack'] ?> </span>        
                    ...
                    <span><?= $language_library['Quantity'] ?> </span>
                   <div class="input-group mt-2 mb-4">
                      ...
                      <span class="input-group-btn ml-2">
                         ...
                         <!-- <span class="text-left" style="color: #00afef;">20 </span>
                        <span class="ml-3" style="color: #bbb;">Available</span> -->    
                        </div>        
                        
                    <div class="col-md-8 col-xs-3 d-flex mb-3 mt-4 text-right">   
                    <div class="row">    
                    <p class="price col-md-12" >
                        <span ><?= $language_library['Total Price'] ?> - </span>
                    ...
                    <p class=" col-md-12"><a onclick="cart()" class="btn btn-black py-3 px-5 xs-w100"><?= $language_library['Add to Cart'] ?></a></p>    
                    </div> 
                        </div>    
          ...
          <div class="col-lg-8 mt-5 ftco-animate">
            <span class="subheading"><?= $language_library['Product'] ?> <strong><?= $language_library['Description'] ?></strong></span>
              <!-- <h2>Description</h2> -->
                     <h5 class="mb-4" style="margin-top: 24px; margin-bottom: 4px !important;"><?= $language_library['Short Description'] ?> </h5>
                    <?= $data[0]['shor_desc'] ?>
                    <h5 class="mb-4" style="margin-top: 24px; margin-bottom: 4px !important;"><?= $language_library['Long Desciption'] ?></h5>
                    <?= $data[0]['long_desc'] ?>
                    <h5 class="mb-4" style="margin-top: 24px; margin-bottom: 4px !important;"><?= $language_library['Other Description'] ?> </h5>
                    <?= $data[0]['other_desc'] ?>
          </div>
               <div class="col-lg-4 mt-5 ftco-animate">
                    <span class="subheading">Product</span>
                    <?php $review = $this->api_model->get_data('product_id = '.$data[0]['id'].'' , 'products_reviews', '', 'COUNT(product_id) AS NumberOfProducts'); //print_r($review);?>
                    <h2 class="mb-4"> <?= $language_library['Reviews']?> <span class="reviewcount">(<?php echo $review[0]['NumberOfProducts']; ?>)</span></h2>
                    <p>
                      ...
                      <?php }else{ ?>
                        <a data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                          <?= $languge_library['Write a new review'] ?>
                        </a>
                      <?php } ?>
                    </p>
                    <div class="collapse forreview" id="collapseExample">
                      ...
                      <!-- <div class="form-group">
                        <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Your name *" name="" id="name">
                      </div> -->
                      <div class="form-group">
                    ...
                    if(!empty($review)){
                      ...
                      <?php } ?>
                      <a href="<?= base_url('frontend/all_review/')?><?= $data[0]['id'] ?>" class="float-right"><?= $language_library['view all'] ?></a>
                    <?php }else{ ?>
                      <p>No Review Found</p>
                    <?php } ?>
                </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-3 pb-3">
          <div class="col-md-12 heading-section text-center ftco-animate">
            <span class="subheading"><?= $language_library['Products'] ?> </span>
            <h2 class="mb-4"><?= $language_library['Related Products'] ?></h2>
											...
											<?php if($this->session->userdata("users_id")){ ?>
												<span href="#" class="add-to-cart d-flex justify-content-center align-items-center text-center">
													<div class="dropdown dropup">
														...
														<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
															<a class="dropdown-item" onclick="intrested_to_buy(<?= $da['id'] ?>)"><?= $langauge_libray['Interested In buying the product. Please contact us.'] ?> </a>
											...
											<?php }else{ ?>
												<span href="#" class="add-to-cart d-flex justify-content-center align-items-center text-center">
													<div class="dropdown dropup">
														...
														<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
															<a class="dropdown-item" href="<?= base_url('frontend/interest/'.$da['id']) ?>"><?= $langauge_libray['Interested In buying the product. Please contact us.'] ?> </a>
