...
?>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-12 p-5 bg-white rounded shadow-sm mb-5">
          ...
          <div class="p-4">
            <p class="font-italic mb-4"><?= $language_library['Shipping and additional costs are calculated based on values you have entered.'] ?></p>
              <div class="col-lg-12">
            <ul class="list-unstyled mb-4">
              ...
              <!-- <li class="d-flex justify-content-between py-3 border-bottom"><strong class="w50">Shipping and handling</strong><strong class="text-right"><svg class="w4" x="0px" y="0px" viewBox="0 0 500 500">
                    ...
                    <li class="d-flex justify-content-between py-3 border-bottom"><strong><?= $language_library['Tax'] ?></strong><strong class="text-right"><svg class="w5" x="0px" y="0px" viewBox="0 0 500 500">
                              <use xlink:href="#rupee"></use>
                              </svg><?php echo number_format($total_price*($tax[0]['tax_percentage']/100), 2); $app_tax = $total_price*($tax[0]['tax_percentage']/100);
                   ...
                   // $wallet_dr = $this->api_model->get_data('users_id = "'.$_SESSION['users_id'].'" AND status = "Dr" AND wallet_type = "1"', 'livestoc_wallets','','sum(amount) as sum');
                     ...
                     $total_price += ($total_price*($tax[0]['tax_percentage']/100));
                     $wallet = 0;
                     $wall = 0;
                     if($wallet < $round_price){ 
                       ...
                       ?>
                                  ...
                                  <div class="col-lg-12 pad">
                                      <p class="font-italic mb-4"><strong><?= $language_library['TOTAL AMOUNT'] ?> :  <svg class="w3" x="0px" y="0px" viewBox="0 0 500 500">
                                        <use xlink:href="#rupee"></use>
                                  ...
                                  <div class="col-12 col-md-4">
                                    ...
                                    <input type="submit" value="<?= $language_library['Cash On Delivery'] ?>" class="btn btn-dark rounded-pill check btn-block">
                                    </form>
                                  </div>
                                  </div>
                  ...
                  <form method="post">
                    ...
                    <div class="row">   
                          <div class="col-12 col-md-8">
                              <input type="submit" name="submit" class="btn btn-dark rounded-pill check btn-block" value="<?= $language_library['Pay Now'] ?> <?= number_format($round_price, 2) ?> Rs">
                          </div>
                          <div class="col-12 col-md-4">
                              <input type="submit" value="<?= $language_library['Cash On Delivery'] ?>" class=" btn btn-dark rounded-pill check btn-block">
                          </div>
   ...
   <script>  $( document ).ready(function() {
										$(".razorpay-payment-button").val("<?= $language_library['Pay Now'] ?> <?= $tamount ?> Rs ");
