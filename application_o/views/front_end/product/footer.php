    <?php //print_r($language_library['All Products']);?>
    <section class="ftco-section ftco-no-pt ftco-no-pb py-5 bg-light">
      <div class="container py-4">
        <div class="row d-flex justify-content-center py-5">
          <div class="col-md-6">
            <h2 style="font-size: 22px;" class="mb-0"><?= $language_library['Subscribe to our Newsletter'] ?></h2>
            <span><?= $language_library['Get e-mail updates about our latest shops and special offers'] ?></span>
          </div>
          <div class="col-md-6 d-flex align-items-center subscribe-form">
            <!-- <form action="#" class="subscribe-form"> -->
              <div class="form-group d-flex">
                <input type="text" class="form-control" id="sub_email" placeholder="<?= $language_library['Enter Email address'] ?> ">
    ...
    <footer class="ftco-footer ftco-section">
      <div class="container">
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2"><?= $language_library['Livestock Pro'] ?></h2>
              <p><?= $language_library['Connect with millions of farmers and their Animals & grow your Practice and income through direct communication.'] ?></p>
              <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
                <li class="ftco-animate"><a href="https://www.facebook.com/livestocpetcare/"><span class="icon-facebook"></span></a></li>
                <li class="ftco-animate"><a href="https://www.instagram.com/livestocpetcare/"><span class="icon-instagram"></span></a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              <h2 class="ftco-heading-2"><?= $language_library['menu'] ?></h2>
              <ul class="list-unstyled">
                <li><a href="https://www.livestoc.com/" class="py-2 d-block"><?= $language_library['home'] ?></a></li>
                <li><a href="<?= base_url('frontend/product_listing') ?>" class="py-2 d-block"><?= $language_library['shop'] ?></a></li>
                <li><a href="https://www.livestoc.com/blog/" class="py-2 d-block"><?= $language_library['blog'] ?></a></li>
              </ul>
            </div>
          </div>
          <div class="col-md-4">
             <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2"><?= $language_library['Help']?></h2>
              <div class="d-flex">
                <ul class="list-unstyled mr-l-5 pr-l-3 mr-4">
                  <!-- <li><a href="#" class="py-2 d-block">Returns &amp; Exchange</a></li> -->
                  <!-- <li><a href="#" class="py-2 d-block">Terms &amp; Conditions</a></li> -->
                  <li><a href="https://www.livestoc.com/privacy_policy" class="py-2 d-block"><?= $language_library['Privacy Policy']?></a></li>
                </ul>
                <!-- <ul class="list-unstyled">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2"><?= $language_library['Have Questions']?></h2>
        ...
        <p><?= $language_library['Copyright © All rights reserved.']?></p>
          </div>
        </div>
      </div>
    </footer>
...
<?php } ?>
  ...
  function cart(product_id, price, pack, user_id, type){
    app_url = "<?= base_url('/frontend'); ?>";
    if(user_id == ''){
      window.location.href = "<?= base_url() ?>/frontend/login";
    }
    cart_add(product_id, pack, price, '1', user_id, type);
  }
