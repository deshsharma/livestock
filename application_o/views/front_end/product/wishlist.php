                  ...
                  <div class="col-lg-6 col-12">
                    ...
                    <div class="p-4">
                      <ul class="list-unstyled mb-4">
                        <li class="d-flex justify-content-between py-3 border-bottom"><strong><?= $language_library['Order Subtotal'] ?> </strong><strong class="text-right"><svg class="w4" x="0px" y="0px" viewBox="0 0 500 500">
                                  <use xlink:href="#rupee"></use>
                                  ...
                                  ?>
                        <li class="d-flex justify-content-between py-3 border-bottom"><strong><?= $language_library['Tax'] ?></strong><strong class="text-right"><svg class="w4" x="0px" y="0px" viewBox="0 0 500 500">
                                  <use xlink:href="#rupee"></use>
                                  </svg><span class="tax_product"><?= $app_tax = number_format($total_price*($tax[0]['tax_percentage']/100), 2)  ?></span></strong></li>
                        <li class="d-flex justify-content-between py-3 border-bottom"><strong><?= $language_library['Total'] ?></strong><strong class="text-right"><svg class="w4" x="0px" y="0px" viewBox="0 0 500 500">
                                  <use xlink:href="#rupee"></use>
