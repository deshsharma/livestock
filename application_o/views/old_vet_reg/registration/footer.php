<div class="footer">
  <div class="container">
    <div class="row">
      ...
      <p class="mL30">+91 1800 102 0379</p>
      </div>
      ...
      <ul class="mL0 mL0-xs pl-0">
        <li class="list-inline-item">
          <a href="https://www.facebook.com/livestocpetcare" target="_blank" class="fb hvr-grow"><i class="fab fa-facebook-f"></i></a></li>
        <li class="list-inline-item">
          <a href="https://twitter.com/livestocpetcare" target="_blank" class="twitter hvr-grow"><i class="fab fa-twitter"></i></a></li>
        <li class="list-inline-item">
          <a href="https://www.instagram.com/livestocpetcare" target="_blank" class="twitter hvr-grow"><i class="fab fa-instagram"></i></a></li>    
      </ul>
      </div>      
      </div>        
      </div>
