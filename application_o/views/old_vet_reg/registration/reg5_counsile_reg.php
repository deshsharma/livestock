      ...
      <div class="formTotal">
        <div class="row">
          <div class="col-md-4 col-12 stepsecbg">
            ...
            <div class="stepsec">
              <p class="stepsec"><span class="step-counter">04</span><span class="nomob"> Registration Details</span></p>
            </div>
            <div class="stepsec">
              <p class="blue1"><span class="step-counter-activ">05</span><span class="nomob"> Council Registration Details</span></p>
            </div>
            <div class="stepsec">
              <p><span class="step-counter">06</span><span class="nomob"> Bank Details</span></p>
            </div>
            <div class="stepsec">
              <p><span class="step-counter">07</span><span class="nomob"> Select Language</span></p>
            </div>
          </div>
      <div class="col-md-8">
                      ...
                      <div class="form-row">
                          ...
                          <option value="">Year</option>
                            ...
                            foreach($council_year as $year){ ?>
                              <option <?php if($council_year == $year) echo"selected"; ?> value="<?= $year ?>"><?= $year['state_name'] ?> Veterinary Council</option>
                            <?php } ?>
                          </select>
