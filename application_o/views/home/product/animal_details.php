            ...
            <div class="row mt-md-0 mt-4">
              <div class="col-md-4 pr-0 pl-0">
                <div class="primary-grey p-2 pl-3">
                  ...
                  <?php if($data[0]['state'] != ''){?><p>State: <strong><?php echo $data[0]['state'];?></strong></p><?php } ?>     
                </div>
              </div>
              <div class="col-md-4 pl-md-0 pl-2">
                <div class="primary-grey p-2 pr-3 text-left">
                  ...
                  <?php if($data[0]['lactation'] != '' && $data[0]['lactation'] != '0') {?><p>Lactation: <strong><?php echo $data[0]['lactation'];?></strong></p> <?php }?>
                </div>
              </div>
              <div class="col-md-4 pl-md-0 pl-2">
              </div>
