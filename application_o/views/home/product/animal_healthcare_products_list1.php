...
<section class="amnimal-listing liv-animal-healthcare">
...
<section class="sell-animals">
      <div class="container-fluid">
        <div class="row px-3">
          ...
          <a href="<?= base_url() ?>homenew/buy_animals"><img src="<?= base_url() ?>assets/home/images/sell-animals.jpg" class="img-fluid"></a>
          </div>
        </div>
      </div>
    </section>
