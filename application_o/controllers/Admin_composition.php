...
class Admin_composition extends CI_Controller {
    ...
    public function composition_add(){
        if(isset($_REQUEST['submit'])){ 
            ...
            $data['name_hi'] = $this->input->get_post('name_hi');
            $data['name_pa'] = $this->input->get_post('name_pa');
			$data['unit'] = $this->input->get_post('rate_unit');
			$this->form_validation->set_rules('name','Please Enter Composition Name English','required|trim');
            // $this->form_validation->set_rules('name_hi','Please Enter Composition Name Hindi','required|trim');
            // $this->form_validation->set_rules('name_pa','Please Enter Composition Name Punjabi','required|trim');
			$this->form_validation->set_rules('rate_unit','Please Select Unit','required');
			if($this->form_validation->run('add_bank')){
                if($detail = $this->api_model->submit('feed_composition', $data)){
