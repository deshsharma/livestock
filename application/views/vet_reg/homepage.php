...
<html lang="en">
  <head>
    <title> Get the Best Veterinarians on Call - Livestoc | Veterinarians Near Me & Veterinary Services at Home</title>
    <meta charset="utf-8">
    ...
    <!-- <link rel="stylesheet" type="text/css" href="util.css"> -->
  	...
  	<!-- <link href="<?= base_url() ?>assets/vetreg/css/hover-min.css" rel="stylesheet"> -->
    ...
    <meta name="description" content="Get the best veterinary doctor at home from Livestoc. Our Expert Vets are available on call. Search for Veterinarians near me and find the best veterinary doctors for home visit at livestoc.com. Our Veterinary Doctors are Highly Expeirenced and Offers the best animal health care services at home " />
  </head>
  <body>
...
<nav class="navbar navbar-expand-lg navbar-light nav-bg">
  <a class="navbar-brand" href="https://www.livestoc.com"><img src="<?= base_url() ?>harpahu_merge/assets/vetreg/images/logo.png" alt="logo"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('animal-treatment') ?>">Services</a>
      </li>
      <li class="nav-item">
...
<div class="home">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="<?= base_url() ?>harpahu_merge/assets/vetreg/images/home/v1.jpg" class="d-block w-100" alt="slide1">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="section-choose mt-5">
        <h5>I AM A</h5> 
        <p class="style1 hvr-grow"><a href="<?= base_url() ?>veterinary-doctors/product_otp"> QUALIFIED VETERINARIAN</a></p>
        <p disabled class="style1 hvr-grow"><a href="<?= base_url() ?>veterinary-doctors/vt_otp">QUALIFIED VETERINARY ASSISTANT</a></p>
        <p disabled class="style1 hvr-grow"><a href="<?= base_url() ?>veterinary-doctors/ai_otp">TRAINED AI WORKER</a></p>
      </div>
    </div>
    <div class="col-12 col-md-6 pad0">
        <img src="<?= base_url() ?>harpahu_merge/assets/vetreg/images/home/cow.gif" class="mt-20per mt-0per img-fluid" alt="slide1">
...
<img class="img-fluid" src="<?= base_url() ?>harpahu_merge/assets/vetreg/images/logo.png" alt="logo"> 
<p class="mt-3 hidden-xs hvr-grow">© 2019 - <?= date('Y');?>· <a href="https://www.livestoc.com"> livestoc.com</a> <br> All Rights Reserved</p>    
</div>
...
<p class="mL30 mL0-xs">
<a href="#"><img class="img-fluid w-48 hvr-grow" src="<?= base_url() ?>harpahu_merge/assets/vetreg/images/gPlay.png" alt="logo"></a>
<a href="#"><img class="img-fluid w-48" src="<?= base_url() ?>harpahu_merge/assets/vetreg/images/ios.png" alt="logo"></a></p>
</div>      
<div class="col-md-4 mt-4 text-center-xs">
<h3 class="mT0"> Follow Us on</h3>
<ul class="mL0 mL0-xs pl-0">
<li class="list-inline-item"><a href="https://www.facebook.com/Livestocfarmmanagement/" target="_blank" class="fb hvr-grow"><i class="fab fa-facebook-f"></i></a></li>
<li class="list-inline-item"><a href="https://in.linkedin.com/company/livestoc" target="_blank" class="twitter hvr-grow"><i class="fab fa-linkedin-in"></i></a></li>
