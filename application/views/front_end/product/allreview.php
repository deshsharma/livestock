    	...
    	<div class="container">
    		<div class="row">
    			...
    			<div class="col-lg-2 mb-5 ftco-animate">
    				<a href="<?= base_url('harpahu_merge/uploads/product/')?><?= $image[0] ?>" class="image-popup"><img src="<?= base_url('harpahu_merge/uploads/product/')?><?= $image[0] ?>" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				<h3><?= $data[0]['name'] ?></h3>
    				<div class="rating d-flex">
							<p class="text-left mr-4">
								<a href="#" class="mr-2" style="color: #00afef;"><?php  $avg = $this->api_model->get_data('product_id = '.$data[0]['id'].' AND is_active = "1"' , 'products_reviews', '', 'AVG(rating) as rating'); echo number_format($avg[0]['rating'], 1); ?> <span style="color: #bbb;"><?= $this->webLanguage['Rating']?></span></a>
							</p>
							<p class="text-left mr-4">
								<a href="#" class="mr-2" style="color: #00afef;"><?php $count = $this->api_model->get_data('product_id = '.$data[0]['id'].' AND is_active = "1"' , 'products_reviews', '', 'COUNT(rating) as count'); echo $count[0]['count']; ?> <span style="color: #bbb;"><?= $this->webLanguage['Reviews']?></span></a>
							</p>
						</div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 mt-2 ftco-animate">
                    <h2 class="mb-4"><?= $this->webLanguage['All Reviews']?> <span class="reviewcount">(<?php $count = $this->api_model->get_data('product_id = '.$data[0]['id'].' AND is_active = "1"' , 'products_reviews', '', 'COUNT(rating) as count'); echo $count[0]['count']; ?>)</span></h2>
                    <p>
    ...
    <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="product">
              <a href="<?= base_url('frontend/product_view/').$rel['id'] ?>" class="img-prod"><img class="img-fluid" src="<?= base_url('harpahu_merge/uploads/product/')?><?= $image[0] ?>" alt="Colorlib Template">
