...
<hr class="m0">
    ...
    <section class="ftco-section pt-0 pb-0">   
    	<div class="container-fluid">
            ...
            <h5 class="filterexpand"><?= $this->webLanguage['Select Filters']?></h5>
            ...
            <div class="row">
                <div class="col-12 mt-4">
                    <p><?= $this->webLanguage['Categories']?></p>				
						          <?= $category ?>              
                 </div>
            </div>    
			<?php //} ?>
            ...
            <ul class="nav nav-pills mb-3 forscrl" id="pills-tab" role="tablist">
					<li class="nav-item">
						<a class="nav-link <?php if($sec_id == ''){ echo 'active'; } ?>" href="<?= base_url('frontend/product_listing'); ?>" role="tab" aria-controls="pills-home-tab" aria-selected="true"><?= $this->webLanguage['All Products']?></a>
					</li>
              ...
              foreach($section as $sec){
                ...
                ?>
                  <li class="list-inline-item">
                      <a class="nav-link <?php if($sec_id == $sec['id']){ echo 'active'; } ?>" id="pills-profile-tab"  href="<?= base_url('frontend/product_listing/').$cat.'/'.$sec['id'] ?>" style="background-image: url('');"><?= $sec[$name] ?></a>
                  </li>
                  <?php
                }            
            ?>
            </ul>
             <?php if(empty($data_pro) && empty($data)){
               echo '<div class="d-flex justify-content-around  mb-3"><img src="https://www.livestoc.com/uploads_new/banners/noproductFound.png"></div><h5 class="d-flex justify-content-around  mb-3">'.$this->webLanguage['No Products List Avilable'].'</h5>';
            }else{ ?>
                <div class="bg-featured">
            <div class="row justify-content-center mb-3">
          <div class="col-md-12 heading-section text-left ftco-animate">
           <? if(!empty($data_pro)){
            echo'<h5 class="mb-4 pl-3 pl-sm-5 pl-md-5">'.$this->webLanguage['Premium Products'].'</h5>'; }?>
            ...
            <div class="row pl-3 pl-sm-5 pl-md-5 pr-3 pr-sm-5 pr-md-5">
                ...
                <div class="col-md-6 col-lg-4 col-6 ftco-animate premium">
    				<div class="product">
    					<a href="<?= base_url('frontend/product_view/').$da['id'] ?>" class="img-prod">
                            <div class="forimg">
                            <img class="img-fluid" src="<?= base_url('harpahu_merge/uploads/product/')?><?= $image[0] ?>" alt="Livestoc">
                            </div>    
    						<span class="status"><img class="img-fluid" src="<?= base_url('harpahu_merge/uploads/product/premium.png') ?>" alt="Livestoc"></span>
                ...
                <h3 class="fordet"><a href="<?= base_url('frontend/product_view/').$da['id'] ?>" ><?php echo substr($da['name'], 0, 15); ?>..</a></h3>
                            </div>
                          
                            <?php
                             if($da['video_id'] != ''){ ?>
                                      <div class="col-4 video text-center pl-0 mt-2 mb-2">
                                      <a class="myvid" data-link="<?= base_url('uploads/product/')?><?= $da['video_id'] ?>" data-vedio="<?= $da['video_id'] ?>">    
                                      <i class="fa fa-play mb-2" aria-hidden="true"></i><br>    
                                      <span><?= $this->webLanguage['Watch Video']?></span>
                                      </a>    
                                      </div> 
                          <?php } ?>
    					</div>
                        ...
                        <div class="text pb-3 text-left cart">
    						<div class="d-flex">
    							<div class="pricing">
                                    ...
                                    <p class="mb-0 add w-50 text-left float-left bdrrnew" onclick="cart(<?= $da['id'] ?>, <?= $price[0]['pack_id'] ?>, <?= $price[0]['id'] ?>,<?= $userId ?>, <?= $userType ?>)"><?= $this->webLanguage['Add to Cart']?></p>
                                    <p class="mb-0 w-50 add text-left float-left pl-2 pricenew"><span class="mr-2 price-dc"><svg class="w55new" x="0px" y="0px" viewBox="0 0 500 500">
                                        ...
                                        <use xlink:href="#rupee"></use>
                                        </svg><?php if($this->session->userdata("user_type") == 1) { echo $price[0]['sale_price'];}else{ echo $price[0]['vt_sale_price']; } ?></span>
                                    </p>
                                    </div>    
                                    <?php if($this->session->userdata("users_id")){ ?>
                                    <div class="dropdown float-left w-100 mt-2 pl-3 pr-3">
                                      <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                      <?= $this->webLanguage['I am Interested']?> <i class="fa fa-ellipsis-v" aria-hidden="true"></i> 
                                      </button>
                                         
                                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" onclick="intrested_to_buy(<?= $da['id'] ?>)"><?= $this->webLanguage['Interested In buying the product.Please contact us']?></a>
                                    ...
                                    <?php }else{ ?>
                                      ...
                                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="<?= base_url('frontend/interest/'.$da['id']) ?>"><?= $this->webLanguage['Interested In buying the product.Please contact us']?></a>
                                    ...
                                    <?php } ?>
                                     ...
                                     <p class="mb-0 add w-60 text-left ratingnew float-left"><i class="fa fa-star"></i> <?php  $avg = $this->api_model->get_data('product_id = '.$da['id'].'' , 'products_reviews', '', 'AVG(rating) as rating'); echo number_format($avg[0]['rating'], 1); ?> <span>| <?= $this->webLanguage['Reviews']?> : <?php $count = $this->api_model->get_data('product_id = '.$da['id'].'' , 'products_reviews', '', 'COUNT(rating) as count'); echo $count[0]['count']; ?></span></p><p class="mb-0 add w-50 text-right float-left" id="canShare">
            ...
            <div class="row pl-3 pl-sm-5 pl-md-5 pr-3 pr-sm-5 pr-md-5">
              ...
              <?php if($da['video_id'] != ''){ ?>
              	<div class="col-11 video text-center mt-2 mb-1">
                            <a class="" data-link="<?= base_url('uploads/product/')?><?= $da['video_id'] ?>" data-vedio="<?= $da['video_id'] ?>">    
                ...
                <h3 class="fordet"><a href="<?= base_url('frontend/product_view/').$da['id'] ?>" ><?= $da['name'] ?></a></h3>
                        ...
                        <div class="text pb-1 text-left cart">
    						<div class="d-flex">
    							<div class="pricing">
                                    <div class="forcartnew">
                                    <p class="mb-0 add text-left float-left bdrrnew" onclick="cart(<?= $da['id'] ?>, <?= $price[0]['pack_id'] ?>, <?= $price[0]['id'] ?>, <?= $userId ?>, <?= $userType ?>)"><i class="fa fa-shopping-cart" aria-hidden="true"></i></p>
                                    <p class="mb-0 add text-left float-left pl-2 pricenew"><span class="mr-2 price-dc d-none"><svg class="w55new" x="0px" y="0px" viewBox="0 0 500 500">
                                         <use xlink:href="#rupee"></use>
                                        </svg><?= $price[0]['mrp'] ?></span><span class="price-sale"> &#8377; <?php if($this->session->userdata("user_type") == 1) { echo $price[0]['sale_price'];}else{ echo $price[0]['vt_sale_price']; } ?></span>
                                    </p>
                                    </div>    
                                    <?php if($this->session->userdata("users_id")){ ?>
                                    <div class="dropdown float-left w-100 mt-2 pl-1 pr-1">
                                      ...
                                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" onclick="intrested_to_buy(<?= $da['id'] ?>)"><?= $this->webLanguage['Interested In buying the product.Please contact us']?> <br></a>
                                    ...
                                    <?php }else{ ?>
                                      ...
                                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="<?= base_url('frontend/interest/'.$da['id']) ?>"><?= $this->webLanguage['Interested In buying the product.Please contact us']?> <br></a>
      ...
      <?php if(empty($data)){
            ...
            <!-- tab 1 -->    
              <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                <h5 class="mb-4 pl-3 pl-sm-5 pl-md-5"><?= $this->webLanguage['All Products']?></h5>
                <div class="row">  
				<?php 
				foreach($data as $da){
					$image = explode(',',$da['images']);
					...
					?>	
						<div class="col-md-6 col-lg-3 col-6 ftco-animate">
							<div class="product">
								<a href="<?= base_url('frontend/product_view/').$da['id'] ?>" class="img-prod"><img class="img-fluid" src="<?= base_url('harpahu_merge/uploads/product/')?><?= $image[0] ?>" alt="Livestoc" style="height: 182px; width: 100%;">
								...
								<div class="text py-3 pb-4 text-center">
									...
									<div class="d-flex">
										...
										<use xlink:href="#rupee"></use>
										</svg><?php if($this->session->userdata("user_type") == 1) { echo $price[0]['sale_price'];}else{ echo $price[0]['vt_sale_price']; } ?></span></p>
										</div>
									</div>
                        ...
                        <span>
											...
											<?php } ?>
											<a  onclick="cart(<?= $da['id'] ?>, <?= $price[0]['pack_id'] ?>, <?= $price[0]['id'] ?>,<?= $userId ?>, <?= $userType ?>)" class="buy-now d-flex justify-content-center align-items-center mx-1">
