                ...
                <!-- <div class="col-md-6 col-lg-4 ftco-animate premium">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="<?= base_url() ?>assets/product/images/product-1.jpg" alt="Livestoc">
    						<span class="status"><i class="fa fa-trophy" aria-hidden="true"></i></span>
    						<div class="overlay"></div>
    					</a>
    					
                        <div class="text py-3 pb-3 pl-3 text-left">
                            <div class="row">
                            <div class="col-8">    
    						<h3 class="mt-2"><a href="#">Rapid Test Kit</a></h3>
                            </div>
                        ...
                        <div class="text py-3 pb-3 pl-3 pr-3 mt-2 text-left cart">
    						<div class="d-flex">
    							<div class="pricing">
                                    <div class="dropdown">
                                      <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Ask company to Contact me <i class="fa fa-ellipsis-v" aria-hidden="true"></i> 
                                      </button>
                                         
                                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="#">Interested In buying the product. <br>Please contact us. </a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="#">I am interested in being dealer <br> or distributor </a>
                                      </div>
                                    </div>
                                    <hr>
                                    <p class="mb-0 add w35 text-left">Add to Cart</p>
                                    <p class="mb-0 w65 add text-right"><span class="mr-2 price-dc"><svg class="w55g" x="0px" y="0px" viewBox="0 0 500 500">
