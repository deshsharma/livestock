<link rel="stylesheet" href="<?= base_url() ?>assets/product/css/style2.css">
    <?php 
      $whishlist_data = $this->api_model->get_whishlist($this->session->userdata("users_id"));
      if(empty($whishlist_data)) { ?>
        <section class="ftco-section ftco-cart bg_gradient">
            <div class="container">
                <div class="row">
                  <div class="col-lg-10 p-5 bg-white rounded shadow-sm mb-5"><?= $this->webLanguage['Your Whishlist is empty']?></div> 
                </div>
              </div>
          </section>
  <?php } else { ?>
                  ...
                  <div class="col-lg-6 col-12">
                    ...
                    <div class="p-4">
                      <ul class="list-unstyled mb-4">
                        <li class="d-flex justify-content-between py-3 border-bottom"><strong>Order Subtotal </strong><strong class="text-right"><svg class="w6" x="0px" y="0px" viewBox="0 0 500 500">
                                  <use xlink:href="#rupee"></use>
                                  ...
                                  ?>
                        <li class="d-flex justify-content-between py-3 border-bottom"><strong>Tax</strong><strong class="text-right"><svg class="w6" x="0px" y="0px" viewBox="0 0 500 500">
                                  <use xlink:href="#rupee"></use>
                                  </svg><span class="tax_product"><?= $app_tax = number_format($total_price*($tax[0]['tax_percentage']/100), 2)  ?></span></strong></li>
                        <li class="d-flex justify-content-between py-3 border-bottom"><strong>Total</strong><strong class="text-right"><svg class="w6" x="0px" y="0px" viewBox="0 0 500 500">
                                  <use xlink:href="#rupee"></use>
                      ...
                      <?php if($this->session->userdata("users_id") != ""){ 
                        ...
                        ?>
                      <a href="<?= base_url('frontend/wishlist_checkout/') ?>" class="btn btn-dark rounded-pill check btn-block mt-4">Procceed to checkout</a>
                      <?php }else{?>
                        <a href="<?= base_url('frontend/product_reg/1') ?>" class="btn btn-dark rounded-pill check btn-block mt-4">Procceed to checkout</a>
                      <?php } ?>
                    </div>
                  </div>
                </div>
