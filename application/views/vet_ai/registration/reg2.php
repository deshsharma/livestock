              ...
              <form class="form-detail" method="POST" id="myform" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-row form-row-2">
                      ...
                      <input type="text" value="<?php echo $mobile ?>" type="text" maxlength="10" minlength="10" pattern="[0-9]{10}" name="mobile" class="mobile" id="phone" placeholder="Phone Number" >
                    </div>
                  </div>
                   <div class="form-row">
                  ...
                  <div class="form-row form-row-1">
                      ...
                      <!-- <?php echo form_error('confirm_passcode'); ?>
                      <input value="<?php echo $passcode ?>" autocomplete="off" type="password"  maxlength="4" minlength="4" pattern="[0-9]{4}" name="confirm_passcode" class="zip" id="confirm_passcode" placeholder="Confirm Passcode" required> -->
                  </div>
                  <!-- <div class="msg blue1">The above pass code is used to login in the App.</div> -->
                  
                  <!-- <div class="form-row">
                    <?php echo form_error('adhar'); ?>
                    <input type="text" name="adhar" class="additional" id="adhar" placeholder="Aadhar Number" required>
                    <button type="button" class="btn btn-light btn-style1">upload</button>
                  </div> -->
                  ...
                  <div class="form-group">
                      ...
                      <div class="form-row form-row-2">
                       ...
                       <div class="custom-file">
                                <input type="file" name="profile_image" id="profile_image_re" class="imgInp custom-file-input" aria-describedby="inputGroupFileAddon01">
                                <label class="custom-file-label_re" for="profile_image">UPLOAD PHOTO</label>
                            </div>
                        <!-- <input type="file" name="app_cvupload" title=" " class="fullwidth input rqd"> -->
                      </div>
                  </div>
                 ...
                 <div class="form-checkbox" style="width:100%;margin-left:10px;">
                  ...
                  <label class="container"><div class="msg1 blue1" style="margin-left:16px;margin-top:-18px;">My fee for the telephonic consultation shall be  ₹
                    <input type="text" maxlength="3" name="telephonicConsultText" pattern="{0-9}" class="col-2" placeholder="" style="">per minute.
                        ...
                        <!-- <input type="text" name="telephonicConsultText" class="code" id="telephonicConsultText"><br><br> -->
                  ...
                  <div class="form-checkbox" style="width:100%;margin-left:10px;">
                   ...
                   <label class="container"><div class="msg1 blue1" style="margin-left:16px;margin-top:-18px;">My fee for the home visit shall be ₹ <input type="text" name="homeVisitChangesText" maxlength="3" class="col-2" placeholder="" id="homeVisitChangesText" style=""></div>
                      ...
                      <!-- <input type="text" name="homeVisitChangesText" class="code" id="homeVisitChangesText"><br><br> -->
