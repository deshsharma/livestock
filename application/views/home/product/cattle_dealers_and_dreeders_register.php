                ...
                <div class="row mt-5">
                    ...
                    <div class="col-md-6 offset-md-1 pl-md-0 mt-4 mt-md-0">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <a href="<?= base_url('homenew/champion_bull_list')?>" class="forlink">
                            ...
                            <div class="col-12 mt-4">
                                <div class="dealer neon-green">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="dealer-style">
                                                <a onclick="Dealer()" class="forlink">
                                                    <?php  $cat_name = $this->api_model->get_section_name($category); ?>
                                                <?php if($_REQUEST['category_id'] !='1' ){?>
                                                <p class="mb-0"><?php print_r($cat_name[0]['name']);?> <span><strong><?= $this->webLanguage['Dealers  of India']?></strong></span></p>
                            ...
                            <div class="col-12 mt-4">                                
                                <div class="dealer neon-blue">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="dealer-style">
                                                <a onclick="Breeder()" class="forlink">
                                                <?php  $cat_name = $this->api_model->get_section_name($category);  ?>
                                                <?php if($_REQUEST['category_id'] =='1' ){?>                                                
                                                <p class="mb-0"> <span><?= $this->webLanguage['Top Cattle Breeders  of India']?><strong></strong> </span></p>
                                                <?php }else{?><p class="mb-0"><?php print_r($cat_name[0]['name']);?> <span><strong><?= $this->webLanguage['Breeders of India']?></strong></span></p> <?php }?>
                                                </a>
                                            </div> 
                                        </div>
                                        <div class="col-md-6 pl-md-5 pl-4 mt-2 mt-md-0">
                                            <a href="https://play.google.com/store/apps/details?id=com.it.livestoc&hl=en_IN" class="forlink">
                                            <p class="mt-2"><strong><?= $this->webLanguage['Register For Free Now']?></strong><strong class="blue"></strong> <i class="fas fa-chevron-right float-right pr-3"></i></p></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
  ...
  function Dealer(){
    ...
    // }else{
       window.location.href = "<?= base_url() ?>homenew/dealer_list";
    // }
  }
   function Breeder(){
    // if($('#users_id').val() == '0'){
    //   window.location.href = "<?= base_url() ?>frontend/login";
    // }else{
       window.location.href = "<?= base_url() ?>homenew/breeder_list";
    // }
  }
</script>