                          ...
                          foreach($cart_session as $k=>$cart)
                          {
                                        ...
                                        ?>
                                            <tr>
                                              ...
                                              <td data-label="Price" class="price_sale"><strong><svg class="w10" x="0px" y="0px" viewBox="0 0 500 500">
                                                <use xlink:href="#rupee"></use>
                                                </svg></strong><strong class="sale_price"><? if($this->session->userdata("user_type") == 0){ echo number_format($videoDetailsPrice,2);  }else { echo number_format($videoDetailsPrice,2); } ?></strong>
                                              </td>
                                              ...
                                              <td data-label="Total Price" class="total_price_sale"><strong><svg class="w10" x="0px" y="0px" viewBox="0 0 500 500">
                                                                ...
                                                                if($this->session->userdata("user_type") == 0){
                                                                  echo number_format(($price[0]['sale_price']+$videoDetailsPrice)*$cart['qty'],2);
                                                                  $total_price += number_format(($price[0]['sale_price']+$videoDetailsPrice)*$cart['qty'],2);
                                                                }else{
                                                                  echo number_format(($price[0]['vt_sale_price']+$videoDetailsPrice)*$cart['qty'],2);
