...
<header>
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid align-items-start headermenu text-end text-md-start">
          <a class="navbar-brand" href="<?= base_url() ?>"><img src="<?= base_url() ?>assets/home/images/logo.png" class="img-fluid"></a>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mt-1">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="<?= base_url() ?>"><?= $this->webLanguage['home']?></a>
              ...
              <li class="nav-item">
                <a class="nav-link" href="<?= base_url('veterinary-products-online-india') ?>"><?= $this->webLanguage['Shop']?></a>
              </li>
              <?php if($total_cart){ ?>
                <li class="nav-item">
                  <a class="nav-link cr" href="<?= base_url('frontend/product_cart/') ?>"><img src="<?= base_url() ?>assets/home/images/cart.png" class="me-2 mt-n1"><span><?= $total_cart ?></span></a>
                </li>
              <?php }else{ ?>
                <li class="nav-item">
                  <a class="nav-link cr" href="#"><img src="<?= base_url() ?>assets/home/images/cart.png" class="me-2 mt-n1"></i><span>Cart</span></a>
                </li>
              <?php } ?>
              <li class="nav-item">
                <a class="nav-link" href="<?= base_url('video') ?>"><?= $this->webLanguage['Video Tutorial']?></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="<?= base_url()?>"><?= $this->webLanguage['About Us']?></a>
              </li>
              ...
              <?php if($total_cart){ ?>
                <li class="nav-item carticn">
                  <a class="nav-link" href="<?= base_url('all_videos/video_cart/') ?>"><img src="<?= base_url() ?>assets/home/images/cart.png" class="me-2 mt-n1">[<?= $total_vedio_cart ?>]</a>
                </li>
              <?php }else{ ?>
                <li class="nav-item">
                  <a class="nav-link" href="#"><img src="<?= base_url() ?>assets/home/images/cart.png" class="me-2 mt-n1">Cart</a>
                </li>
              <?php } ?>
              <?php if(!$this->session->userdata("users_id")){ ?>
      ...
      <section class="banner-slider">
        <div class="conatiner-fluid">
          <div class="owl-carousel owl-carousel1">
            <div> 
              <div class="row">
                <div class="col-md-4 pt-md-5 pt-3 ps-4" style="text-align:center;">
                  <h1 style="text-align:center;">Buy Animals from 
                    <span>Livestoc</span></h1>
                    <p class="mt-4" style="text-align:center;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been</p>
                </div>
                <div class="col-md-8">
