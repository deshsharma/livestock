                              ...
                              tr += "<div class='col-md-12' align='center'>We are in process of updating the listings please check after 48 Hrs.</div>";
                                ...
                                delete str.total ;
                                  $.each(result, function(index, item){
                                    ...
                                    if(item.image !== null){
                                      image = '<span class="card1" ><img src="'+item.image+'" alt="Breeder" width="100%"></span>';
                                    }else{
                                        image = '<span class="card1" ><img src="<?= base_url('../uploads_new/profile/')?>1615888678.jpg" alt="Breeder" style="width: 100%;"></span>';
                                    } 
