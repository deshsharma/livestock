...
<section>
  <div class="liv-all-animals primary-grey champ-bull-listing champ-bull-reg">
    ...
    <label type="submit" class="btn btn-primary">Sample Collection Center Application Form</label></br>
      <form action="" method="POST" id="userdetail" enctype="multipart/form-data">  
        ...
        <div class="form-group">
          ...
          <input type="text" value="<?= $user_details[0]['full_name']?>" name="name" class="form-control" id="inputContact" placeholder="Contact Person">
        </div>
        <div class="form-row">
        ...
        <div class="form-group">
          <div class="form-check">
            ...
            <label class="form-check-label" for="gridCheck">
              By ticking this I accept the Terms as applicable.
            </label>
          </div>
        </div>
        <div class="form-group">
          <div class="form-check">      
            <label class="form-check-label" for="gridCheck">
              For inquiries please call 7009058918
            </label>
          </div>
        </div>
