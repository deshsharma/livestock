    	...
    	<div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 mt-2 ftco-animate">
                    <h2 class="mb-4">All Reviews <span class="reviewcount">(<?php $count = $this->api_model->get_data('product_id = '.$data[0]['id'].'' , 'products_reviews', '', 'COUNT(rating) as count'); echo $count[0]['count']; ?>)</span></h2>
                    <p>
