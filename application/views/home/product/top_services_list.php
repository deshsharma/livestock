                ...
                <div class="col-md-6">
                    <div class="dealer neon-green1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 algn">
                                <p class="mt-2"><?= $this->webLanguage['View All Near You']?>  <i class="fas fa-chevron-right float-right pr-3"></i></p>
                            </div>
                        </div></a>
                    </div>
                </div>
                <div class="col-md-6 mt-4 mt-md-0">
                    <div class="dealer neon-blue1">
                                    <div class="row">
                                        ...
                                        <div class="dealer-style">
                                            <a href="#" class="forlink">
                                            <p class="mt-2"><?= $this->webLanguage['Submit Sample Now Only']?>  <i class="fas fa-chevron-right float-right pr-3"></i></p>
                                            </a>
                                        </div>
                                        </div>
                                    </div>
