              ...
              if(empty($whishlist_data)) { ?>
                  <!-- redirect(base_url('all_videos')); -->
                     <section class="ftco-section">
                        <div class="container">
                            <div class="row">
                              <div class="col-lg-10 p-5 bg-white rounded shadow-sm mb-5">Your Whishlist is empty</div> 
                            </div>
                          </div>
                      </section>
              <?php } else { ?>
                    ...
                    <div class="p-4">
                      <ul class="list-unstyled mb-4">
                        <div class="col-md-12 border-bottom">
                                  <div class="col-md-6"><strong>Subtotal </strong></div><div class="col-md-6"><strong class="text-right" style='float: left;'><svg class="w4" x="0px" y="0px" viewBox="0 0 500 500">
                                            <use xlink:href="#rupee"></use>
                                            </svg><span class="total_product_price"><?=  number_format($total_price, 2) ?></span></strong></div>
                                          </div>
                                 <!--  <li class="d-flex justify-content-between py-3 border-bottom"><strong>Subtotal </strong>
                                  </li> -->
                                  <?php $tax =$this->api_model->get_data('' , 'tax_table', '', 'id, name, tax_percentage');?>
                                  <div class="col-md-12 border-bottom">
                                  <div class="col-md-6"><strong>GST </strong></div><div class="col-md-6"><strong class="text-right" style='float: left;'><svg class="w4" x="0px" y="0px" viewBox="0 0 500 500">
                                            <use xlink:href="#rupee"></use>
                                            </svg><span class="total_product_price"><?= $app_tax = number_format($total_price*($tax[0]['tax_percentage']/100), 2)  ?></span></strong></div>
                                          </div>
                                  <div class="col-md-12 border-bottom">
                                  <div class="col-md-6"><strong>Total </strong></div><div class="col-md-6"><strong class="text-right" style='float: left;'><svg class="w4" x="0px" y="0px" viewBox="0 0 500 500">
                                            <use xlink:href="#rupee"></use>
                                            </svg><span class="total_product_price"><?= number_format($app_tax + $total_price, 2) ?></span></strong></div>
                                          </div>
                                  <!-- <li class="d-flex justify-content-between py-3 border-bottom"><strong>Total</strong><strong class="text-right" tyle='float: left; margin-top: -22px;'>
                                      <svg class="w4" x="0px" y="0px" viewBox="0 0 500 500">
                                        <use xlink:href="#rupee"></use>
                                      </svg>
                                      <span class="total_product_total"><span style="float: right;"><?= number_format($app_tax + $total_price, 2) ?></span></span></strong>
                                  </li> -->
                                  <li class="d-flex justify-content-between py-3 ">&nbsp;&nbsp;&nbsp;</li>
                      <!--   <li class="d-flex justify-content-between py-3 border-bottom"><strong>Subtotal </strong><strong class="text-right" style='float: left; margin-top: -22px;'><svg class="w4" x="0px" y="0px" viewBox="0 0 500 500">
                          <use xlink:href="#rupee"></use>
                          </svg><span class="total_product_price"><?=  number_format($total_price, 2) ?></span></strong></li>
                          <?php $tax =$this->api_model->get_data('' , 'tax_table', '', 'id, name, tax_percentage'); 
                          ?>
                        <li class="d-flex justify-content-between py-3 border-bottom"><strong>GST</strong><strong class="text-right" style='float: left; margin-top: -22px;'><svg class="w4" x="0px" y="0px" viewBox="0 0 500 500">
                          <use xlink:href="#rupee"></use>
                          </svg><span class="tax_product"><?= $app_tax = number_format($total_price*($tax[0]['tax_percentage']/100), 2)  ?></span></strong></li>
                        <li class="d-flex justify-content-between py-3 border-bottom"><strong>Total</strong><strong class="text-right" style='float: left; margin-top: -22px;'><svg class="w4" x="0px" y="0px" viewBox="0 0 500 500">
                          <use xlink:href="#rupee"></use>
                      ...
                      <a href="<?= base_url('all_videos/wishlist_checkout/') ?>" class="btn btn-dark rounded-pill check btn-block mt-4">Procceed to checkout</a>
                      <?php }else{?>
                        <a href="<?= base_url('all_videos/wishlist_checkout/') ?>" class="btn btn-dark rounded-pill check btn-block mt-4">Procceed to checkout</a>
                      <?php } ?>
                    </div>
...
<script>
    ...
    function removelike(id){
        ...
        $.ajax({
        type:"POST",
        url: app_url+"/removeVidewishlistlike",
        data:{id:id},
