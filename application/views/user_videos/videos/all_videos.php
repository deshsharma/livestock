                               ...
                               <!--  <div class="row">
                                ...
                                <div class="row">
                                     <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                        <div class="input-group">
                                            <div class="input-group-btn" style="width: 0%!important;%">
                                                <button type="button" class="btn btn-dropdown-custom dropdown-toggle" data-toggle="dropdown"><span class="fa fa-th"></span> <?= $webLanguage['Categories']?> <span class="caret"></span></button>
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a onclick="searchVideoDropDownSections('Cow/Buffalo');" href="#"><?= $webLanguage['Cow / Buffalo']?></a>
                                                    </li>
                                                    <li>
                                                        <a onclick="searchVideoDropDownSections('Dog/Cat');"  href="#"><?= $webLanguage['dog / cat']?></a>
                                                    </li>
                                                    <li>
                                                        <a onclick="searchVideoDropDownSections('Sheep/Goat');" href="#"><?= $webLanguage['Sheep / Goat']?></a>
                                                    </li>
                                                    <li>
                                                        <a onclick="searchVideoDropDownSections('Pig');" href="#"><?= $webLanguage['Pig']?></a>
                                                    </li>
                                                    <li>
                                                        <a onclick="searchVideoDropDownSections('Horse');" href="#"><?= $webLanguage['Horse']?></a>
                                                    </li>
                                                    <li>
                                                        <a onclick="searchVideoDropDownSections('Poultry');" href="#"><?= $webLanguage['Poultry']?></a>
                                                    </li>
                                                    <li>
                                                        <a onclick="searchVideoDropDownSections('Fish');" href="#"><?= $webLanguage['Fish']?></a>
                                                    </li>
                                                </ul>
                                            </div><!-- /btn-group -->
                                            ...
                                            <!-- search language -->
                                            <div class="input-group-btn" style="width: 0%!important;">
                                                <button type="button" class="btn btn-dropdown-custom dropdown-toggle" data-toggle="dropdown"><span class="fa fa-th"></span> <?= $webLanguage['Language']?> <span class="caret"></span></button>
                                                <ul class="dropdown-menu">
                                                    <li>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 addvid pull-right mt20-xs">
                                        <a href="<?= base_url().'all_videos/video_add'; ?>" class="btn btn-primary waves-effect waves-light"><i class="fa fa-plus"></i><?= $webLanguage['Add Tutorials']?></a>
                                    </div>
                                </div>
                            ...
                            <div class="courses-inner res-mg-b-30">
                                    ...
                                    <div class="videoitems">
                                        <div class="icons">
                                            <ul>
                                                ...
                                                <li class="share">
                                                    <button type="button" class="btn btn-dropdown-share dropdown-toggle" data-toggle="dropdown"><?= $webLanguage['Share']?> <span class="fa fa-share ml10"></span>
                                                    </button>
                                ...
                                <div class="product-buttons mt20">
                                    ...
                                    <?php } else if(empty($status_data)) { ?> 
                                        ...
                                        <?php }else{  ?>
                                            <a href="https://www.livestoc.com/frontend/login"><h5 style="width: 40%;">₹<?= $video['price']; ?></h5></a>
                                            <button style="border: none;margin:0;padding:0px;width: 20%;"  onclick="window.location.href='<?= base_url()."all_videos/video_details?video_id=".$video['video_id']; ?>'" type="button" class="fa fa-eye">
                                            </button>
                                            <a href="https://www.livestoc.com/frontend/login" role="button" aria-expanded="false" class="nav-link"> <button style="width: 20%;" type="button" class="fa fa-shopping-cart"></button></a>
                                        <?php } ?>
                                    <?php } else { ?>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="footer-copy-right">
                            <p><?= $webLanguage['Copyright © 2020. All rights reserved. LIVESTOC']?></p>
                        </div>
                    </div>
                </div>
            </div>
