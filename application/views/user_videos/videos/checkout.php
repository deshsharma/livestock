<div class="all-content-wrapper">
    <div class="header-advance-area">
        ...
        <!-- END nav -->
      	...
      	//print_r($_SESSION);
         $i=0;
        foreach($_SESSION['video_session'] as $ve){
          if($i == '0'){
            $video_ids = $ve['video_id'];
          }else{
            $video_ids .= ','.$ve['video_id'];
          }
          $i++;
                  ...
                  <div class="container">
                    ...
                    { 
                      ...
                      if($i==0){
                        ...
                        $package_price = $videoDetailsPrice;
                        ...
                        $product_qty .=','.$cart['qty'];
      								...
      								$total_price += ($videoDetailsPrice)*$cart['qty'];
      							}else{
                      if($i==0){
                        $video_id = $cart['video_id']; 
                        $users_id = $cart['users_id'];
                          ...
                          <ul class="list-unstyled mb-4">
                            <div class="col-md-12 border-bottom">
                                  ...
                                  <div class="col-md-6"><strong>GST </strong></div><div class="col-md-6"><strong class="text-right" style='float: left;'><svg class="w4" x="0px" y="0px" viewBox="0 0 500 500">
                                            <use xlink:href="#rupee"></use>
                                            </svg><span class="total_product_price"><?php $app_tax = $total_price*($tax[0]['tax_percentage']/100); echo number_format($total_price*($tax[0]['tax_percentage']/100), 2);  ?></span></strong></div>
                                          </div>
                                  <div class="col-md-12 border-bottom">
                                  <div class="col-md-6"><strong>Total </strong></div><div class="col-md-6"><strong class="text-right" style='float: left;'><svg class="w4" x="0px" y="0px" viewBox="0 0 500 500">
                                            <use xlink:href="#rupee"></use>
                                            </svg><span class="total_product_price"><?php $tamount = $app_tax + $total_price; echo number_format($app_tax + $total_price, 2); ?></span></strong></div>
                                          </div>
                             ...
                             <div class="col-lg-12 pad">
                                <p class="font-italic mb-4"><strong>TOTAL AMOUNT:  <svg class="w3" x="0px" y="0px" viewBox="0 0 500 500">
                                  <use xlink:href="#rupee"></use>
                                  </svg><span style="float: right;"><?= number_format($tamount,2) ?><span></p></strong>
                            </div>
                            <?php 
                            ...
                            <div class="col-lg-6 pad">   
                                <form action="<?= base_url('all_videos/video_thanku') ?>" method="POST">
                                <script
                                  ...
                                  data-image="https://www.livestoc.com/images/logo.png"
                                  ...
                                  data-notes.product_id="<?= $video_ids ?>"
                                  data-notes.package_id="<?= $video_id ?>"
                                  ...
                                  data-notes.product_type="VIDEO"
                                  data-notes.bank_id="<?= $data[0]['users_id'] ?>"
