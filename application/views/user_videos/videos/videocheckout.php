<div class="all-content-wrapper">
    ...
    <?php 
    	if($this->session->userdata("users_id") == ''){
            ...
            $user = $this->api_model->get_user_detail($this->session->userdata("users_id"));
            //print_r($user);
        }	 
    ?>
                      ...
                      <p class="font-italic mb-4">Shipping and additional costs are calculated based on values you have entered.</p>
                        <div class="col-lg-6">
                          <ul class="list-unstyled ">
                                  ...
                                  </svg><span style="float: right;"><?=  number_format($total_price, 2) ?></span></strong></li>
                                  <?php $tax =$this->api_model->get_data('' , 'tax_table', '', 'id, name, tax_percentage');?>
                                  <li class="d-flex justify-content-between py-3 border-bottom"><strong>GST: </strong><strong class="text-right"><svg class="w4" x="0px" y="0px" viewBox="0 0 500 500">
                                  <use xlink:href="#rupee"></use>
                                  </svg><span style="float: right;"><?php echo number_format($total_price*($tax[0]['tax_percentage']/100), 2); $app_tax = $total_price*($tax[0]['tax_percentage']/100)  ?></span></strong></li>
                                  ...
                                  <use xlink:href="#rupee"></use>
                                  </svg><span style="float: right;"><?php $tamount = $app_tax + $total_price; echo number_format($app_tax + $total_price, 2); ?></span></strong></li>
          
                            </ul>
                             <div class="col-lg-12 pad">
                                <p class="font-italic mb-4"><strong>AMOUNT:  <svg class="w3" x="0px" y="0px" viewBox="0 0 500 500">
                                  <use xlink:href="#rupee"></use>
                                  </svg><span style="float: right;"><?= number_format($tamount, 2) ?><span></p></strong>
                            </div>
                            <?php 

                              $log_data['users_id'] = $user[0]['users_id'];
                            ...
                            <div class="col-lg-6 pad">   
                                ...
                                <script
                                  ...
                                  data-currency="INR"
                                  data-name="<?=$user[0]['fullname'];?>"
                                  data-image="https://www.livestoc.com/images/logo.png"
                                  data-description="LiveStoc"
                                  data-prefill.email="<?= $user[0]['email']; ?>"
                                  data-prefill.contact="<?= $user[0]['mobile']; ?>"
                                  data-notes.purchase_id="<?= $log ?>"
                                  data-notes.product_id="<?= $video_id ?>"
                                  ...
                                  data-notes.bank_id="<?= $user[0]['users_id'] ?>"
