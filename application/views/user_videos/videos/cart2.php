          ...
          <link rel="stylesheet" href="<?= base_url() ?>assets/allvideos/css/style2.css">
              <section class="ftco-section">
                  <div class="container formob">
                      <div class="row">
                        <div class="col-lg-12 p-md-5 pt-5 bg-white rounded shadow-sm mb-5"> 
                          <!-- Shopping cart table -->
                          <table class="cartproducts" style="width: 100%">
                          ...
                          <div class="row pt-4 bg-white rounded shadow-sm " style="padding-bottom: 3rem !important; width: 110%; ">
