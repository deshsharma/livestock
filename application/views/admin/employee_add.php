...
<div class="abc_1" >
    ...
    <?php } ?>
        <?php echo form_open("admin/employee_add/", ['onsubmit'=>'return myFunction()']);?>
            ...
            <div class="col-md-9">
                <?php echo form_input(['type'=>'text','name'=>'phone', 'value'=>'', 'id'=>'phone','class'=>'ch_manset padd_set']) ?>
        	</div>
