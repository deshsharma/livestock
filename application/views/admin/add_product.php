          ...
          <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="packValues<?= $i ?><?= $pack['unit_id']?> pack1 <?= $pack['unit_id']?> 
                        ...
                        <div class="forproduct pack <?= $pack['unit_id'] ?>">   
                              <div class="form-group forwd mar">
                               ...
                               <div class="form-group forwd">
                                  <label>MRP</label>
                                  <input type="number" name="pack_mrp[]" class="form-control" placeholder="00.00">
                              </div>    
                              <div class="form-group forwd mar">
                                  <label>Rate for Livestoc</label>
                                  <input type="number" name="pack_sale[]" class="form-control" placeholder="00.00">
                              </div>  
                              <div class="form-group forwd">
                                  <label>Rate for Livestoc Pro</label>
                                  <input type="number" name="pack_sale_price_vt[]" class="form-control" placeholder="00.00">
                              </div> 
                        </div>        
...
$(document).ready(function() {
  loadData(1);
	...
	$('.file-1').change(function(){
		...
		$.ajax({
			url: "<?= base_url() ?>Api/web_upload_Images?path=product",
			type: "POST",
			data: form_data,
			contentType: false,
			cache: false,
