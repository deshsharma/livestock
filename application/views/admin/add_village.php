...
<div class="abc" ><h3>ADD EMPLOYEE</h3></div>
...
<div class="abc_1" >
    ...
    <?php } ?>
        <?php echo form_open("admin/add_village/", ['onsubmit'=>'return myFunction()']);?>
            ...
            <?php echo form_error('vill_code'); ?>
            <div class="col-md-3" > 
        	   <strong class="right_sre">Village Code</strong>
            </div>
            <div class="col-md-9">
                <?php echo form_input(['type'=>'text','name'=>'vill_code', 'value'=>'', 'id'=>'vill_code','class'=>'ch_manset padd_set']) ?>
        	</div>
            <?php echo form_error('name'); ?>
            <div class="col-md-3" > 
        	   <strong class="right_sre">Village Name</strong>
            </div>
            <div class="col-md-9">
