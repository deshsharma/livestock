...
<div class="abc" ><h3>ADD BULL</h3></div>
...
<div class="abc_1" >
    ...
    <?php } ?>
        <?php echo form_open_multipart("admin/add_bull/", ['onsubmit'=>'return myFunction()']);?>
            ...
            <div class="col-md-9">
                <?php echo form_input(['type'=>'text','name'=>'bull_no', 'value'=>'', 'id'=>'bull_no','class'=>'ch_manset padd_set']) ?>
        	</div>
            ...
            <div class="col-md-9">
                <?php echo form_input(['type'=>'text','name'=>'bull_id', 'value'=>'', 'id'=>'bull_id','class'=>'ch_manset padd_set']) ?>
        	</div>
            ...
            <div class="col-md-9">
                <?php echo form_input(['type'=>'text','name'=>'dob', 'value'=>'', 'id'=>'datepicker','class'=>'ch_manset padd_set', 'autocomplete'=>'off']) ?>
        	</div>
            ...
            <div class="col-md-9">
                <?php echo form_input(['type'=>'text','name'=>'sire_no', 'value'=>'', 'id'=>'sire_no','class'=>'ch_manset padd_set', 'autocomplete'=>'off']) ?>
        	</div>
            ...
            <div class="col-md-9">
                <?php echo form_input(['type'=>'text','name'=>'dam_no', 'value'=>'', 'id'=>'dam_no','class'=>'ch_manset padd_set', 'autocomplete'=>'off']) ?>
        	</div>
            ...
            <div class="col-md-9">
                <?php echo form_input(['type'=>'text','name'=>'lat_yield', 'value'=>'', 'id'=>'lat_yield','class'=>'ch_manset padd_set', 'autocomplete'=>'off']) ?>
        	</div>
            ...
            <div class="col-md-9">
                <?php echo form_input(['type'=>'text','name'=>'lact_no', 'value'=>'', 'id'=>'lact_no','class'=>'ch_manset padd_set', 'autocomplete'=>'off']) ?>
        	</div>
            ...
            <div class="col-md-9">
                ...
                <option >Select Bull Source</option>
                    <?php foreach($data as $da){ ?>
                        <option value="<?= $da['bank_id'] ?>"><?= $da['bank_name'] ?></option>
                    <?php }?>
                </select>
        	</div>
            ...
            <div class="col-md-9">
                <?php echo form_input(['type'=>'file','name'=>'image', 'id'=>'image','value'=>$image,'class'=>'ch_manset padd_set']); ?>
        	</div>
