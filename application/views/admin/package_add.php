...
<div class="abc_1" >
    ...
    <?php } ?>
        <?php echo form_open("admin/package_add/", ['onsubmit'=>'return myFunction()']);?>
            ...
            <div class="col-md-3" > 
                <strong class="right_sre">Quantity In Package</strong>
                </div>
                <div class="col-md-9">
            ...
            <div class="col-md-3" > 
                <strong class="right_sre">Package Unit Name</strong>
            </div>
            <div class="col-md-9">
