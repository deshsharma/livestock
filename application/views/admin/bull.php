...
<section class="content">
                  ...
                  <!-- <form action="<?= base_url('admin/bull_import/'.$_SESSION['user_id']);?>" id="form" enctype="multipart/form-data" method="post">
	                   <div class="form-row form-row-2" style="margin-bottom: 20px;">
	                        <input type="file" id="uploadFile" name="uploadFile" class="" required />
	                    </div>
